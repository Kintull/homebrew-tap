class GithubTracker < Formula
  ...
  url "https://github.com/Kintull/gihub-pr-poller/archive/refs/tags/v0.2.2.tar.gz"
  sha256 "28ab339c3f027b6aaa65b2acd0972f5e6256a0ccad941860f4e200b2852368d9"
  license "MIT"
  ...
  resource "mdit-py-plugins" do
    url "https://files.pythonhosted.org/packages/source/m/mdit-py-plugins/mdit_py_plugins-0.5.0.tar.gz"
  ...
  resource "platformdirs" do
    url "https://files.pythonhosted.org/packages/source/p/platformdirs/platformdirs-4.9.2.tar.gz"
  ...
  resource "textual" do
    url "https://files.pythonhosted.org/packages/source/t/textual/textual-8.0.0.tar.gz"
